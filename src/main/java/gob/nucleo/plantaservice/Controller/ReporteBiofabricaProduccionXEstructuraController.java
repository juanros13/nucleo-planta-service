...
import gob.nucleo.plantaservice.services.IReporteBiofabricaProduccionXEstructuraService;
...
@RestController
public class ReporteBiofabricaProduccionXEstructuraController {

    @Autowired
    IReporteBiofabricaProduccionXEstructuraService reporteBiofabricaProduccionXEstructuraService;

    @GetMapping("/reporteBioProdXEstructura/{idEstructura}")
